...
<style>
   ...
   h1 {
    ...
    font-size: 18px; 
    text-align: center;   
    background: linear-gradient(45deg, #000000, #1c1c1c, #383838, #545454, #707070, #888888, #a9a9a9, #d3d3d3);
...
<div class="container-fluid mt-3 px-4">
    <div class="row mb-4">
        <div class="col-12 col-md-8 col-lg-6">
            <label for="ideven" class="form-label fw-bold">Seleccione un evento:</label>
            <select id="ideven" name="ideven" class="form-select form-select-lg" required style="width: 100%; min-width: 300px;">
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-edit-ponente', function() {
        ...
        $('#formPonente')[0].scrollIntoView({ behavior: 'smooth', block: 'start' });
